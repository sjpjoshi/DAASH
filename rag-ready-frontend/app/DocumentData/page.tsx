...
export default function DocumentDataPage() {
  ...
  return (
  <div className="flex flex-col align-center items-center justify-center w-full">
          ...
          <table className="min-w-full">
            <thead>
              <tr className="border-b">
                ...
                <th className="py-2 px-4 text-left">Verification Level</th>
                <th className="py-2 px-4 text-left">Query Count</th>
                <th className="py-2 px-4 text-left">Verification Priority</th>
                <th className="py-2 px-4 text-left">Common Query</th>
              </tr>
            </thead>
            <tbody>
              {isLoading ? (
